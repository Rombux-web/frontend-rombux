...
function FormSections() {
  ...
  return (
    <div className='relative z-10 mt-[107px] flex flex-col items-center max-sm:mt-[60px]'>
      <h2 className='text-white text-[32px] leading-[36px] text-center max-sm:text-[38px]'>
        ¿Conectamos?
      </h2>
      <form
      ...
      >
        <div>
          ...
          />
          {errors.nombre && (
            <p className='text-red-700 px-2 rounded-sm bg-gray-300 text-sm mt-1 text-left'>
              {errors.nombre}
            </p>
          )}
        </div>
        ...
        <div className='w-[638px] h-[340px] border border-[#707070] rounded-[5px] pt-[26px] pl-6 space-y-8 bg-white mt-8 max-sm:w-[336px] max-sm:space-y-6 max-sm:pl-3 max-sm:mt-2 max-sm:pt-[15px]'>
          ...
          {errors.servicios && (
            <p className='text-red-700 px-2 rounded-sm bg-gray-300 text-sm mt-1 max-sm:mb-[-8px] ml-[-22px] max-sm:ml-[-12px] text-left max-sm:translate-y-2'>
              {errors.servicios}
            </p>
          )}
        </div>
        ...
        <div className='w-[638px] h-[212px] border border-[#707070] rounded-[5px] p-3 bg-white mt-8 max-sm:w-[336px] max-sm:h-[113px] max-sm:mt-2'>
          ...
          />
          {errors.mensaje && (
            <p className='text-red-700 px-2 rounded-sm bg-gray-300 mt-1 max-sm:mb-[-8px] ml-[-12px] text-left text-sm translate-y-2 w-[636px] max-sm:w-[334px]'>
              {errors.mensaje}
            </p>
          )}
        </div>
