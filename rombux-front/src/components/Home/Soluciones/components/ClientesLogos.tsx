    ...
    <div className="w-full flex justify-center pt-6">
      ...
      <div className="grid grid-cols-4 place-items-center gap-y-10 gap-x-20 mt-6 w-full px-0 lg:hidden border-amber-500 mb-5 max-md:gap-x-10 max-sm:gap-x-0 sm:mx-4">
        <div className="relative w-[52px] h-[27px]">
          <Image src="/hpblanco.png" alt="HP" width={52} height={27}/>
        </div>
        <div className="relative w-[83px] h-[12px]">
          <Image src="/DowAgroSciences.svg" alt="Dow Agro" width={83} height={12}/>
        </div>
        <div className="relative w-[35px] h-[28px]">
          <Image src="/Group.png" alt="Super Pollo" width={35} height={28}/>
        </div>
        <div className="relative w-[41px] h-[28px]">
          <Image src="/Amarula blanco.png" alt="Amarula" width={41} height={28}/>
        </div>
        <div className="relative w-[47px] h-[13px]">
          <Image src="/The Clinic blanco.png" alt="The Clinic" width={47} height={13}/>
        </div>
        <div className="relative w-[49px] h-[27px]">
          <Image src="/Granix.png" alt="Granix" width={49} height={27}/>
        </div>
        <div className="relative w-[61px] h-[21px]">
          <Image src="/Advanta blanco.png" alt="Advanta" width={61} height={21}/>
        </div>
        <div className="relative w-[28px] h-[28px]">
          <Image src="/Bi blanco.png" alt="Bi" width={28} height={28}/>
        </div>
      </div>
      ...
      >
        ...
        <div className="relative lg:w-[73px] lg:h-[45px] 2xl:w-[96px] 2xl:h-[56px]">
          <Image src="/hpblanco.png" alt="Imagen HP" width={96} height={56}/>
        </div>
        <div className="relative lg:w-[121px] lg:h-[19px] 2xl:w-[167px] 2xl:h-[25px]">
          <Image src="/DowAgroSciences.svg" width={164} height={25} alt="Imagen Dow Agro"/>
        </div>
        <div className="relative lg:w-[68px] lg:h-[60px] 2xl:w-[71px] 2xl:h-[56px]">
          <Image src="/Group.png" alt="Imagen Super Pollo" width={72} height={56}/>
        </div>
        <div className="relative lg:w-[56px] lg:h-[40px] 2xl:w-[82px] 2xl:h-[56px]">
          <Image src="/Amarula blanco.png" alt="Imagen Amarula" width={100} height={55}/>

        </div>
        <div className="relative w-[68px] h-[48px] 2xl:w-[100px] 2xl:h-[55px]">
          <Image src="/Granix.png" alt="Granix" width={68} height={48}/>
        </div>

        <div className="relative lg:w-[68px] lg:h-[21px] 2xl:w-[109px] 2xl:h-[32px]">
          <Image src="/The Clinic blanco.png" alt="Imagen The Clinic" width={109} height={32}/>
        </div>
        <div className="relative lg:w-[85px] lg:h-[31px] 2xl:w-[116px] 2xl:h-[40px]">
          <Image src="/Advanta blanco.png" alt="Imagen Advanta" width={116} height={40}/>
        </div>
        <div className="relative lg:w-[33px] lg:h-[34px] 2xl:w-[41px] 2xl:h-[40px]">
          <Image src="/Bi blanco.png" alt="Imagen Bi" width={41} height={40}/>
