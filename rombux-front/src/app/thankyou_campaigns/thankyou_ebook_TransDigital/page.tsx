      ...
      <main className='flex-1 pt-[94px] 2xl:pt-[96px] px-4 lg:px-10 2xl:px-[143px] flex items-center justify-center'>
        <section className='max-w-3xl mx-auto text-center'>
          <h1 className='text-3xl md:text-4xl font-light text-black mb-6'>
            Descargar tu e-book Transformación Digital
          </h1>
          <p className='text-gray-700 mb-8'>
            ¡Gracias por completar tus datos! Ya podés descargar tu e-book aquí:
          </p>
          ...
          <a
            ...
            className='inline-flex items-center justify-center bg-[#D81FB9] text-white text-lg font-semibold h-12 px-8 rounded-full transition-transform hover:brightness-110 active:scale-95 leading-none'
          >
            Acá
          </a>
        </section>
